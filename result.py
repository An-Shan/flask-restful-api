...
logging.basicConfig(level=logging.INFO, format=log_info.log_format)
logger = logging.getLogger(__name__)

handler = logging.FileHandler(log_info.log_filename)
handler.setLevel(logging.INFO)

formatter = logging.Formatter(log_info.log_format)
